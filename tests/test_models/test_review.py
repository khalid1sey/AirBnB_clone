...
class TestReviewModel(unittest.TestCase):
    ...
    def test_presence_of_class_attributes(self) -> None:
        """Tests if the mandatory class attributes are present."""
    ...
    def test_unique_objects(self) -> None:
        """Tests to ensure instances are different."""
    ...
    def test_default_class_attribute_values(self) -> None:
        ...
        for attribute, value in self.__class_attributes.items():
    ...
    def test_subclass_of(self) -> None:
        """Tests to verify if Review model objects \
            are sub classes of BaseModel"""
